...
import com.google.library.android.view.refresh.core.listener.OnLoadMoreListener;
import com.google.library.android.view.refresh.core.listener.OnMultiPurposeListener;
import com.google.library.android.view.refresh.core.listener.OnRefreshListener;
import com.google.library.android.view.refresh.core.listener.OnRefreshLoadMoreListener;
...
//    RefreshLayout setEnableNestedScrollOnly(boolean enabled);
     ...
     * Recommended {SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {SimpleMultiPurposeListener}
     ...
     * Recommended {ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {ScrollBoundaryDeciderAdapter}
